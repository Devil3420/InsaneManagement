...
from InsaneRobot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
...
from InsaneRobot.modules.sql.afk_sql import is_afk, check_afk_status
...
from InsaneRobot import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text(
        "<code>Connecting To Insane Server</code>", parse_mode=ParseMode.HTML)

    text = (f"╒═══「<b> Userinfo At Insane Server :</b> 」\n"
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThe Power level of this person is 'tigers of Insane'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Insane/500">What is Ranks</a>]'.format(
            bot.username)
